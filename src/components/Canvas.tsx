...
export default function Canvas() {
  ...
  const [mousePosition, setMousePosition] = useState<mousePosition>({positionX:null, positionY:null});
  const [mouseEndPosition, setMouseEndPosition] = useState<mousePosition>({positionX:null, positionY:null});  
  ...
  const handleMousePositionInSideBar = ({positionX, positionY}:mousePosition)=> {
    ...
    >
      ...
      {selectedObj !== ''&&mousePosition.positionX&&mousePosition.positionY
        ?(
          ...
          <SelectedObj backgroundImg={selectedObj}
          style={{
            position: "absolute",
